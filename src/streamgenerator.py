...
def lagrange_cloud_strip_adT(params):  
    ...
    fc, Mprog, a_s, Tbegin, Tfinal, dtmin, mwhflag, mwdflag, lmcflag, strip_rate, discframe, static_mwh = params
    ...
    write_stream_hdf5(outpath, filename, 
                      ...
                      vs_data[~mask], 
                      ts,
                     pot_label, fc, Mprog, a_s, discframe)
...
lagrange_cloud_strip_adT(params)